SELECT patient_id, FEATURES_LIST_COMMA_SEPARATED, is_screener FROM
(SELECT patient_id, FEATURES_LIST_COMMA_SEPARATED, MAX(is_screener) AS is_screener
FROM
(SELECT t1.patient_id, T1_FEATURES_COMMA_SEPARATED, OPTIONAL_DATE_FTRL3, t2.is_screener FROM
